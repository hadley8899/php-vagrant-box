...
apt-get install -y php php-fpm php-cli php-dom php-zip php-imagick php-xdebug php-mysql php-mbstring php-memcached php-zip php-curl php-bcmath;

# Install PHP 7.4 packages
apt-get install -y php7.4 php7.4-fpm php7.4-cli php7.4-dom php7.4-zip php7.4-imagick php7.4-xdebug php7.4-mysql php7.4-mbstring php7.4-memcached php7.4-zip php7.4-curl php7.4-bcmath;

apt-get install -y php8.2 php8.2-fpm php8.2-cli php8.2-dom php8.2-zip php8.2-imagick php8.2-xdebug php8.2-mysql php8.2-mbstring php8.2-memcached php8.2-zip php8.2-curl php8.2-bcmath;
